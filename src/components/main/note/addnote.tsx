      ...
      <div className={`${addnote ? 'flex' : 'hidden'} w-screen h-screen justify-center relative flex`}>
         ...
         >
            <div className='flex justify-start w-full mb-3'>
               <p className='font-sand text-lg sm:text-2xl text-slate-200 font-medium'>New Notebook</p>
            </div>
            <input
               onInput={(e) => setNoteFn(e)}
               type='text'
               placeholder='Notebook name'
               className=' w-full border font-thin border-gray-300 bg-transparent text-white outline-none p-2.5 font-sand text-sm sm:text-lg'
            />
            <div className='flex flex-row items-center w-full justify-between gap-5'>
               <button
                  ...
                  } w-full shadow p-2 sm:p-4 font-sand text-center text-sm sm:text-lg
                   text-slate-100`}
               >
                  Create Notebook
               </button>
               <button
                  onClick={setaddnote}
                  className='w-full shadow p-1.5 sm:p-4 font-sand text-center text-base sm:text-lg bg-[#646464] text-slate-100'
               >
                  Cancel
               </button>
            </div>
